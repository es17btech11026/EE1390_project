...
for j in range(1,2001):
    b = "/home/adil/last_try/audio_new/new_backs/"+"back_"+str(j)+".wav"
    #print b
...
for j in range(1,2001):                       # reading all the forward.wav files, coverting to mfcc format, adding labels and storing in an array
    b = "/home/adil/last_try/audio_new/new_forwards/" + "forward_"+str(j)+".wav"
    #print b
    data, samplerate = sf.read(b)
    data1 = mfcc(data,samplerate)
    data = data1.reshape(4043,)
...
for j in range(1,2001):                        # reading all the left.wav files, coverting to mfcc format, adding labels and storing in an array  
    b = "/home/adil/last_try/audio_new/new_lefts/" + "left_"+str(j)+".wav"
    #print b
    data, samplerate = sf.read(b)
    data1 = mfcc(data,samplerate)
    data = data1.reshape(4043,)
...
for j in range(1,2001):
    b = "/home/adil/last_try/audio_new/new_rights/"+"right_"+str(j)+".wav"
    #print b
    data, samplerate = sf.read(b)
    data1 = mfcc(data,samplerate)
    data = data1.reshape(4043,)
...
for j in range(1,2001):
    b = "/home/adil/last_try/audio_new/new_stops/"+"stop_"+str(j)+".wav"
    #print b
    data, samplerate = sf.read(b)
    data1 = mfcc(data,samplerate)
    data = data1.reshape(4043,)
...
for j in range(nEpochs):                                # training the dataset
